...
names(lc_1)[names(lc_1)=="evento"]<-"Evento"
...
names(lc_2)[names(lc_2)=="evento"]<-"Evento"

View(lc_1)
View(lc_2)

informacion_datos1 = data.frame(lc_1["Acrónimo"], lc_1["Título"],lc_1["Descripción"],lc_1["Año"],lc_1["Mes"],lc_1["Día"],lc_1["Ciudad"],lc_1["País"],lc_1["Tópicos"],lc_1["Evento"])
informacion_datos2 = data.frame(lc_2["Acrónimo"], lc_2["Título"],lc_2["Descripción"],lc_2["Año"],lc_2["Mes"],lc_2["Día"],lc_2["Ciudad"],lc_2["País"],lc_2["Tópicos"],lc_2["Evento"])
general = rbind(informacion_datos1,informacion_datos2)

View(general)

setwd("./") 
informacion = data.frame(general["Acrónimo"],general["Título"], general["Descripción"],general["Año"],general["Mes"],general["Día"],general["Ciudad"],general["País"],general["Tópicos"],general["Evento"])
